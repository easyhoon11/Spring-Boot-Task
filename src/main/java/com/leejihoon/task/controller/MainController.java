...
import com.leejihoon.task.dto.response.ResponseDto;
...
public class MainController {
    ...
    public String postSchedule(@Valid @RequestBody PostRequestBodyDto postBodyDto) {
        return "일정 작성하기 " + "일정이름: " + postBodyDto.getScheduleName() + "카테고리: " + postBodyDto.getCategory() + "설명: "
                + postBodyDto.getDescription() + "날짜: " + postBodyDto.getDate() + "시간: " + postBodyDto.getTime();
    }

    @PatchMapping("task/{taskNumber}")
    public String patchSchedule(@Valid @RequestBody @PathVariable("taskNumber") String taskNumber,
            PatchRequestBodyDto patchBodyDto) {
        return "일정 수정하기" + "일정번호: " + patchBodyDto.getTaskNumber() + "일정이름: " + patchBodyDto.getScheduleName()
                + "카테고리: " + patchBodyDto.getCategory() + "설명: " + patchBodyDto.getDescription() + "날짜: "
                + patchBodyDto.getDate() + "시간: " + patchBodyDto.getTime();
    }
